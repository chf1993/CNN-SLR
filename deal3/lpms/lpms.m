...
classdef lpms < handle
    ...
    properties (Constant)
        ...
        LPMS_GYR_AUTOCAL_ENABLED = bitshift(1, 30);%bitshift(A,k)：这个MATLAB函数返回向左平移了k位的A，相当于乘以2k。
        ...
        LPMS_STREAM_FREQ_5HZ = 5;%stream流，freq频率
    ...
    properties
        ...
        configurationRegister = 0;%configuration配置；register注册
